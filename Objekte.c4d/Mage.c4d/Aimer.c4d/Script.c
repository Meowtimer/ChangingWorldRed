...
protected func ControlUp()            { ClearLastPlrCom(GetController()); if(!GetPlrCoreJumpAndRunControl(GetController())) return(DoUpDownControl(-AIMR_StepAngle)); }
protected func ControlDown()          { ClearLastPlrCom(GetController()); if(!GetPlrCoreJumpAndRunControl(GetController())) return(DoUpDownControl(AIMR_StepAngle)); }
