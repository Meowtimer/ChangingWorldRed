...
/*
public func ErzeugeNachricht(int iPlr, int vPlr, string message)
{
 var nachricht = CreateObject(NOTH,0,0,iPlr);
 nachricht -> SetAction("Message1",this());
 nachricht -> SetMessage(message);
 nachricht -> SetViewer(vPlr);
}*/
...
/* Globale Überladungen fürs Kombosystem */
